...
const imageOptions: DropdownOption[] = [
  ...
  {
    text: "PHP Logo",
    value: "https://www.php.net/images/logos/new-php-logo.svg",
  },
  {
    text: "Alternative PHP Logo",
    value: "https://www.php.net/images/logos/php-logo.svg",
  },
...
const App = (_: any, state: AppState, setState: SetState) => {
  ...
  url.searchParams.append("watermarkText", watermarkText);
      ...
      H(
        ...
        H(Field, {
          ...
          input: H(Dropdown, {
            ...
            onchange: (val: string) =>
              setLoadingState({ packageManager: val, overrideUrl: url }),
          }),
        }),
        H(Field, {
          label: "Package Name",
